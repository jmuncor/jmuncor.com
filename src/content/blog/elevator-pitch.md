...
1. **Value:** Based on the [definition of value](https://www.protopace.com/p/discover-the-true-definition-of-value), we need to form a hypothesis about what value we can deliver to our prospect, associated with revenue, costs, or risks.
2. **Approach:** How do your deliver such value, this is where you get to talk about the product or service you are selling. This should be one sentence maximum!
3. **Uniqueness:** What are your differentiators compared to the market? If you have multiple, choose one or two that are the most significant or the most relevant for your prospect.
4. **Proof:** Give some proof, either social, technical or evidential to validate that you can deliver the value mentioned on the first item.
